...
const LoginForm: React.FC<LoginFormProps> = ({ onToggleMode }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Welcome back to SurplusLink!');
    } catch (error: any) {
    ...
    >
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">Sign in to continue making an impact</p>
        </div>
        ...
        <div className="mt-6 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
          <p className="text-sm text-green-700 dark:text-green-300 font-medium mb-2">Demo Instructions:</p>
          <p className="text-xs text-green-600 dark:text-green-400">
            Create an account first by clicking "Sign up here", then come back to login with your credentials.
          </p>
        </div>
      </div>
    </motion.div>
